  ...
  const filtered = useMemo(() => {
    ...
    return tickets.filter((ticket) => {
      ...
      return (
        ...
        toLabel(ticket.ai_category, CATEGORY_LABELS).toLowerCase().includes(q) ||
              ...
              <tbody>
                {filtered.map((ticket) => (
                  ...
                  >
                    ...
                    <td className="admin-table-muted">{toLabel(ticket.category, CATEGORY_LABELS)}</td>

                    <td>
                      <div className="admin-table-title" style={{ fontSize: '0.82rem' }}>
                        {ticket.ai_category ? toLabel(ticket.ai_category, CATEGORY_LABELS) : 'Not triaged'}
                      </div>
